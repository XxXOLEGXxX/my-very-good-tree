...
addLayer("b", { //HALVEDLOL
		...
		effect() { //HALVEDLOL
			if (!this.layer.unlocked || inChallenge("ne", 11)) return new Decimal(1);
...
addLayer("g", { //HALVEDLOL
		...
		effect() { //HALVEDLOL
			if (!this.layer.unlocked || inChallenge("ne", 11)) return new Decimal(0);
		...
		powerEff() { //HALVEDLOL
			if (!this.layer.unlocked) return new Decimal(1);
...
addLayer("t", { //HALVEDLOL
		...
		effect() { //HALVEDLOL
			if (!this.layer.unlocked) return {gain: new Decimal(0), limit: new Decimal(0)};
			else return {
		...
		effect2() { //HALVEDLOL
			if (!((Array.isArray(tmp.ma.mastered))?tmp.ma.mastered.includes(this.layer):false) || !this.layer.unlocked) return new Decimal(1);
		...
		enEff2() { //HALVEDLOL
			if (!this.layer.unlocked) return new Decimal(0);
		...
		buyables: {
			...
			11: { //HALVEDLOL
				...
				effect(x=player[this.layer].buyables[this.id]) { // Effects of owning x of the items, x is a decimal
					...
					if (!this.layer.unlocked) x = new Decimal(0);
...
addLayer("i", { //HALVEDLOL
		...
		buyables: { //HALVEDLOL
			...
			11: {
                ...
                unlocked() { return this.layer.unlocked }, 
                canAfford() {
					let cost = tmp[this.layer].buyables[this.id].cost
			...
			13: {
                ...
                unlocked() { return this.layer.unlocked && ((Array.isArray(tmp.ma.mastered))?tmp.ma.mastered.includes(this.layer):false) }, 
                canAfford() {
					let cost = tmp[this.layer].buyables[this.id].cost
...
addLayer("ge", { //HALVEDLOL
		...
		clickables: {
			...
			11: { //HALVEDLOL
				...
				effect() { return Decimal.pow(tmp.ge.clickables[this.id].effectPer.div(2), player.ge.clickables[this.id]/2) }, //HALVEDLOL
			...
			13: { //HALVEDLOL
				...
				effect() { return Decimal.pow(tmp.ge.clickables[this.id].effectPer.div(2), player.ge.clickables[this.id]/2) },
				unlocked() { return player.ge.unlocked },
				canClick() { return player.ge.unlocked && tmp.n.dustProduct.gte(tmp.ge.clickables[this.id].req) },
				onClick() { 
					if (player.ge.maxToggle && hasMilestone("ge", 0)) {
...
addLayer("mc", { //HALVEDLOL
		...
		update(diff) {
			...
			if (hasMilestone("mc", 1) && player.mc.auto) {
				player.mc.clickables[11] = new Decimal(player.mc.clickables[11]).max(player.mc.mechEn.times(tmp.mc.mechEnMult));
				player.mc.clickables[12] = new Decimal(player.mc.clickables[12]).max(player.mc.mechEn.times(tmp.mc.mechEnMult));
				player.mc.clickables[21] = new Decimal(player.mc.clickables[21]).max(player.mc.mechEn.times(tmp.mc.mechEnMult));
				player.mc.clickables[22] = new Decimal(player.mc.clickables[22]).max(player.mc.mechEn.times(tmp.mc.mechEnMult));
			}
		},
		mechEnMult() {
			let mult = new Decimal(1);
		...
		clickables: { //HALVEDLOL
			...
			11: { //HALVEDLOL
				...
				effect() { 
					let eff = Decimal.pow(player.ge.energy.div(2).plus(1), Decimal.sub(1, Decimal.div(1, Decimal.add(player.mc.clickables[this.id]/2, 1).log10().plus(1).sqrt())));
			...
			12: { //HALVEDLOL
				...
				effect() { return Decimal.pow(player.ps.points.div(2).plus(1), Decimal.sub(1, Decimal.div(1, Decimal.add(player.mc.clickables[this.id]/2, 1).log10().plus(1).sqrt()))) },
				unlocked() { return player.mc.unlocked },
				canClick() { return player.mc.unlocked },
				onClick() {
					if (player.mc.clickables[this.id].eq(0)) {
			...
			21: { //HALVEDLOL
				...
				effect() { return Decimal.pow(player.o.points.div(2).plus(1), Decimal.sub(tmp.mc.clickables[this.id].effExp, Decimal.div(tmp.mc.clickables[this.id].effExp, Decimal.add(player.mc.clickables[this.id]/2, 1).log10().plus(1).root(8)))) },
				unlocked() { return player.mc.unlocked },
				canClick() { return player.mc.unlocked },
				onClick() {
					if (player.mc.clickables[this.id].eq(0)) {
			...
			22: { //HALVEDLOL
				...
				effect() { return Decimal.pow(player.hs.points.div(2).plus(1), Decimal.sub(1, Decimal.div(1, Decimal.add(player.mc.clickables[this.id]/2, 1).log10().plus(1).cbrt()))) },
				unlocked() { return player.mc.unlocked },
				canClick() { return player.mc.unlocked },
				onClick() {
					if (player.mc.clickables[this.id].eq(0)) {
		...
		buyables: {
			...
			12: { //HALVEDLOL
                ...
                unlocked() { return this.layer.unlocked && player.mc.upgrades.includes(11) }, 
                canAfford() {
...
addLayer("ne", { //HALVEDLOL
		...
		buyables: { //HALVEDLOL
			...
			11: {
                ...
                unlocked() { return this.layer.unlocked && hasMilestone("ne", 0) }, 
                canAfford() {
					if (!tmp[this.layer].buyables[this.id].unlocked) return false;
...
addLayer("c", { //HALVEDLOL
		...
		buyables: {
			...
			11: {
                ...
                unlocked() { return this.layer.unlocked && player.c.points.gte(6) }, 
                canAfford() {
					if (!tmp[this.layer].buyables[this.id].unlocked) return false;
					let cost = layers[this.layer].buyables[this.id].cost();
...
addLayer("paradox", { //HALVEDLOL
		...
		effectDescription() { //HALVEDLOL
			return "which boosts global speed by "+format(tmp.paradox.effect.root(2))+"x "+(tmp.nerdMode?"((log3((n+1)^2)+1)^2)":"")
		},
		update(diff) {
